    ...
    for share in data:
        ...
        if tickers is None or ticker in tickers:
            if ticker not in hashtab:
                ...
                # pr_high
                try:
                    new_data[index_of_share][4] = max(
                        float(new_data[index_of_share][4]), float(share[4]))
                except:
                    print("pr_high")
                ...
                # pr_low
                new_data[index_of_share][5] = min(
                    float(new_data[index_of_share][5]), float(share[5]))
                ...
                # val
                new_data[index_of_share][9] = float(
                    new_data[index_of_share][9]) + float(share[9])

                # trades
                new_data[index_of_share][10] = float(
                    new_data[index_of_share][10]) + float(share[10])
                ...
                try:
                    ...
                    new_data[index_of_share][12] = (
                        pr_close - pr_open) * 100 / pr_open
                except:
                    print(ticker)
                    save1 = data.index(share)
                    print(save1)
...
#     filenames = ['tradestats_2020.csv', 'tradestats_2021.csv',
#                  'tradestats_2022.csv', 'tradestats_2023.csv', 'tradestats_2023_rem.csv']
